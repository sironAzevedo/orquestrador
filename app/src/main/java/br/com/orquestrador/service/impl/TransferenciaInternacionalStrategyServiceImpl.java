...
@TipoTransferenciaAnnotation(TipoTransferenciaEnum.INTERNACIONAL)
public class TransferenciaInternacionalStrategyServiceImpl implements ITransferenciaStrategyService {

    @Value(value = "${events.kafka.topic.transaction-internacional}")
    ...
    public void metrica(PayloadResponse.@NonNull Dto dto) {
        log.info("Processando as transações Internacionais: {}", dto);
